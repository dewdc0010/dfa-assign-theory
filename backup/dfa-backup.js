...
function detail_dfa() {
    swal.fire({
        title:"รายละเอียดงาน",
        html: "h = เลือก Hot Coffee<br/>c = เลือก Iced Coffee<br/>1 = เหรียญ 1$<br/>5 = เหรียญ 5$<br/>b = ยกเลิก<br/><br/>กรณี Accept<br/>- เลือก Hot Coffee แล้วหยอดเหรียญครบ 8$ หรือมากกว่า<br/>- เลือก Iecd Coffee แล้วหยอดเหรียญครบ 10$ หรือมากกว่า<br/>- Back จะทำการย้อนกลับมาที่การเริ่มต้น (Final State)<br/><br/>**หมายเหตุ<br/>- หากหยอดเหรียญมากกว่าราคาสินค้า ระบบจะทอนเงินให้<br/>- หากหยอดเหรียญก่อนที่จะเลือกสินค้า ระบบจะทำการคืนเงินให้",
        width: 600,
        backdrop: `
        rgba(0,0,123,0.4)
      `
