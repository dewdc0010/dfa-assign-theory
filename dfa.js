...
function detail_dfa() {
    swal.fire({
        title:"รายละเอียดงาน",
        html:"คำสั่งในการใช้งานไมโครเวฟมีดังนี้<br/>h = อุณหภูมิสูงสุด<br/>m = อุณหภูมิปานกลาง<br/>l = อุณหภูมิต่ำสุด<br/>1 = ทำงานเป็นเวลา 1 นาที<br/>2 = ทำงานเป็นเวลา 2 นาที<br/>3 = ทำงานเป็นเวลา 3 นาที<br/>s = เริ่มต้น<br/>c = ยกเลิก<br/><br/>กรณีที่จะ Accept<br/>- เลือก 'อุณหภูมิ' เลือก 'เวลา' แล้วเลือก 'เริ่มต้น' นับเวลาจนจบการทำงาน<br/>- Cancel แล้วกลับมาที่จุดเริ่มต้น<br/><br/>กรณีที่จะ Reject<br/>- เลือก 'อุณหภูมิ' เลือก 'เวลา' แล้วไม่เลือกที่จะ 'เริ่มต้น' หรือ 'ยกเลิก' ",
        width: 600,
        backdrop: `
        rgba(0,0,123,0.4)
      `
